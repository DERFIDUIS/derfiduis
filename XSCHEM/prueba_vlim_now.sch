...
spiceprefix=X
mult=1}
C {devices/code_shown.sym} 320 -430 0 0 {name=s1 only_toplevel=false value=".dc V1 0 6 0.1
.save all"}
C {devices/code.sym} 170 -430 0 0 {name=TT_MODELS1
only_toplevel=true
...
"
spice_ignore=false}
C {devices/lab_pin.sym} 650 -320 0 0 {name=p2 sig_type=std_logic lab=v1}
