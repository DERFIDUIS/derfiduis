...
N 890 -260 890 -170 {
lab=GND}
C {devices/code_shown.sym} 410 -330 0 0 {name=s1 only_toplevel=false value=".ac lin 100000 1 10G
.save all"}
...
C {sky130_fd_pr/cap_mim_m3_1.sym} 1030 -270 0 0 {name=C1 model=cap_mim_m3_1 W=25.8 L=25.8 MF=3 spiceprefix=X}
